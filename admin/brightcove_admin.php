...
function brightcove_menu() {
  ...
  add_menu_page(__('Brightcove Settings'), __('Brightcove'), 'manage_options', 'brightcove_menu', 'brightcove_menu_render', plugins_url('/admin/bc_icon.png',BCVC_FILTER_FILE)); 
