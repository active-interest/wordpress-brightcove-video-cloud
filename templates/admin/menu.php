    ...
    <?php settings_fields( 'brightcove-settings-group' ); ?>
      ...
      <table class='form-table'> 
        <tbody>
          ...
          <tr valign="top">
            <th scope="row">
              <label for="bc_default_featured">Default Featured </label>
            </th>
            <td>
              <input value = '<?php echo get_option('bc_default_featured'); ?>' name="bc_default_featured" type="text" id="bc_default_featured" class="boolean regular-text" placeholder='Default featured for videos'>
              <span class='description'>Default featured for videos</span>
            </td>
          </tr>
    ...
    <div id="brightcove-settings-help" class="brightcove-settings-help">
      ...
      <p id='player-key-help' >To retrieve the Key for a player: 
        <ol>
          ...
          <h4>Example</h4> 
          <img src='<?php echo plugins_url('/admin/playerKey.png', BCVC_FILTER_FILE) ?>' title='Player Key Example' />
        </ol>
      </p>
